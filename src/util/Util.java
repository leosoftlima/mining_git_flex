...
public class Util {
    ...
    public static String SELECTED_PROJECTS_FILE = "output/selected-projects.csv";
    public static String PREPARED_PROJECTS_FILE = "input/projects-input.csv";
    ...
    public static String PROBLEMS_FILE = "output/problems.txt";
